...
//====================================================================
#define  DEFAULT_GAIT_SPEED 25  // Default gait speed  - Will depend on what Servos you are using...
...
//#define cXXTibiaLength    127  // MEASURE THIS!!! Guessed now :-)
